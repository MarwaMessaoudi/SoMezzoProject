...
import './manager.css';  // Make sure the styles are loaded
...
const Dashboard = ({ onLogout }) => {
  ...
  if (user.role === "MANAGER") {
    navigationLinks = (
      <>
        <a href="#">Dashboard</a>
        <a href="/Registration">Add an Account</a>
        <a href="edit-user/:id">Edit My Account</a>
        <a href="/Tovalidate">Accounts Validation</a>
        <a href="/Tovalidate">Account List</a>
